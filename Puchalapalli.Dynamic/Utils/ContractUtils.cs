...
namespace Puchalapalli.Dynamic.Utils
{
    ...
    {
        public static string MethodPreconditionViolated
        ...
        internal static string DynamicObjectResultNotAssignable(string v, Type type1, Type type2, Type returnType)
            => $"DynamicObjectResultNotAssignable: {v}:\n1) {type1}\n2) {type2}\nReturn: {returnType}";
    }
