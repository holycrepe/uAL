...
namespace Puchalapalli.Dynamic
{
    ...
    public class SimpleDynamicObject : IDynamicMetaObjectProvider
    {
        ...
        private sealed class MetaDynamic : DynamicMetaObject
        {
            ...
            internal MetaDynamic(Expression expression, SimpleDynamicObject value)
            ...
            public override DynamicMetaObject BindInvokeMember(InvokeMemberBinder binder, DynamicMetaObject[] args)
            {
                ...
                var call = BuildCallMethodWithResult(
                    "TryInvokeMember",
                    binder,
                    DynamicMetaObjectUtils.GetExpressions(args),
            ...
            public override DynamicMetaObject BindCreateInstance(CreateInstanceBinder binder, DynamicMetaObject[] args)
            {
                ...
                {
                    return CallMethodWithResult("TryCreateInstance", binder, DynamicMetaObjectUtils.GetExpressions(args), (e) => binder.FallbackCreateInstance(this, args, e));
                }
            ...
            public override DynamicMetaObject BindInvoke(InvokeBinder binder, DynamicMetaObject[] args)
            {
                ...
                {
                    return CallMethodWithResult("TryInvoke", binder, DynamicMetaObjectUtils.GetExpressions(args), (e) => binder.FallbackInvoke(this, args, e));
                }
            ...
            public override DynamicMetaObject BindBinaryOperation(BinaryOperationBinder binder, DynamicMetaObject arg)
            {
                ...
                {
                    return CallMethodWithResult("TryBinaryOperation", binder, DynamicMetaObjectUtils.GetExpressions(new DynamicMetaObject[] { arg }), (e) => binder.FallbackBinaryOperation(this, arg, e));
                }
            ...
            public override DynamicMetaObject BindGetIndex(GetIndexBinder binder, DynamicMetaObject[] indexes)
            {
                ...
                {
                    return CallMethodWithResult("TryGetIndex", binder, DynamicMetaObjectUtils.GetExpressions(indexes), (e) => binder.FallbackGetIndex(this, indexes, e));
                }
            ...
            public override DynamicMetaObject BindSetIndex(SetIndexBinder binder, DynamicMetaObject[] indexes, DynamicMetaObject value)
            {
                ...
                {
                    return CallMethodReturnLast("TrySetIndex", binder, DynamicMetaObjectUtils.GetExpressions(indexes), value.Expression, (e) => binder.FallbackSetIndex(this, indexes, value, e));
                }
            ...
            public override DynamicMetaObject BindDeleteIndex(DeleteIndexBinder binder, DynamicMetaObject[] indexes)
            {
                ...
                {
                    return CallMethodNoResult("TryDeleteIndex", binder, DynamicMetaObjectUtils.GetExpressions(indexes), (e) => binder.FallbackDeleteIndex(this, indexes, e));
                }
                ...
                var callDynamic = new DynamicMetaObject(
                    Expression.Block(
                        ...
                        Expression.Condition(
                            Expression.Call(
                                GetLimitedSelf(),
                                typeof(SimpleDynamicObject).GetMethod(methodName),
                                BuildCallArgs(
                                    binder,
                                    args,
                                    callArgs,
            ...
            private bool IsOverridden(string method)
            {
                ...
                {
                    if (mi.DeclaringType != typeof(SimpleDynamicObject) && mi.GetBaseDefinition().DeclaringType == typeof(SimpleDynamicObject))
                    {
                        return true;
                    }
                }
            ...
            private BindingRestrictions GetRestrictions()
            {
                ...
                return BindingRestrictionsUtils.GetTypeRestriction(this);
            }
            ...
            private Expression GetLimitedSelf()
            {
                ...
                if (TypeUtils.AreEquivalent(Expression.Type, typeof(SimpleDynamicObject)))
                {
                    return Expression;
                }
