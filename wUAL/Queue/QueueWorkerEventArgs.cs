...
namespace wUAL.Queue
{
    ...
    public class DoQueueWorkEventArgs<TArgument> : DoWorkEventArgs
	{
        ...
        public DoQueueWorkEventArgs(TArgument argument) : base(null)
		{
	...
	public class QueueProgressChangedEventArgs<TQueueItem> : ProgressChangedEventArgs where TQueueItem : QueueItemBase
	{
		...
		public QueueProgressChangedEventArgs(int progressPercentage, QueueWorkerState<TQueueItem> userState) : base(progressPercentage, userState) {
	...
	public class QueueProgressChangedEventArgs : QueueProgressChangedEventArgs<QueueItemBase>
	{
		...
		public QueueProgressChangedEventArgs(int progressPercentage, QueueWorkerState userState) : base(progressPercentage, userState) { }
	}
}
