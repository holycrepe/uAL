...
namespace wUAL
{
    public class CountConverter : BaseConverter
    {
    	...
    	public CountConverter(string prefix, string suffix, string textIfBlank) : this(prefix, suffix, textIfBlank, true) { }
    	public CountConverter(string prefix, string suffix, bool usePrefixIfBlank) : this(prefix, suffix, "", usePrefixIfBlank) { }
            ...
            object parameter, CultureInfo culture)
        {
            ...
            prefixSep = " ";
            suffixSep = (strCount == ""  ? "" : " ");
            return (Prefix == null || (count == 0 && !UsePrefixIfBlank) ? "" : Prefix + prefixSep) + strCount + suffixSep + Suffix + (count == 1 ? "" : "s");
        }
    }
}
