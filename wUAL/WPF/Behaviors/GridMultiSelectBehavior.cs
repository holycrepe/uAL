...
namespace wUAL.WPF
{
    public class GridMultiSelectBehavior : Behavior<RadGridView>
    {
        ...
        public static readonly DependencyProperty SelectedItemsProperty =
            DependencyProperty.Register(nameof(SelectedItems), typeof(INotifyCollectionChanged), typeof(GridMultiSelectBehavior), new PropertyMetadata(OnSelectedItemsPropertyChanged));
        ...
        private static void OnSelectedItemsPropertyChanged(DependencyObject target, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (collection != null)
            {
                collection.CollectionChanged += ((GridMultiSelectBehavior)target).ContextSelectedItems_CollectionChanged;
            }
        }
