...
namespace wUAL.UserControls
{
    ...
    public partial class MyEnumEditorExamples : UserControl, INotifyPropertyChanged
    {
        bool _useCombinedFormat = true;

        public MyEnumEditorExamples() : base()
        {
        ...
        {            
            var control = d as MyEnumEditorExamples;
