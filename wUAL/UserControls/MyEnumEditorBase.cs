...
namespace wUAL.UserControls
{
    ...
    public partial class MyEnumEditorBase : UserControl, INotifyPropertyChanged
    {
        bool _useCombinedFormat = true;

        public MyEnumEditorBase() : base()
        {
        ...
        {            
            var myFlagEnumEditor = d as MyFlagEnumEditorBase;
            var value = e.NewValue;
            // myFlagEnumEditor.OnDependencyPropertyChanged(e);
            if (myFlagEnumEditor == null || myFlagEnumEditor.Enum == myFlagEnumEditor.ViewModel.Value)
                return;
