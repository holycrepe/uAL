...
namespace wUAL.UserControls
{
    ...
    public class OutlinedTextBlock : FrameworkElement
    {
        ...
        {
            var OutlinedTextBlockElement = (OutlinedTextBlock)dependencyObject;
            OutlinedTextBlockElement.formattedText = null;
            OutlinedTextBlockElement.textGeometry = null;

            OutlinedTextBlockElement.InvalidateMeasure();
            OutlinedTextBlockElement.InvalidateVisual();
        }

        private static void OnFormattedTextUpdated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            var OutlinedTextBlockElement = (OutlinedTextBlock)dependencyObject;
            OutlinedTextBlockElement.UpdateFormattedText();
            OutlinedTextBlockElement.textGeometry = null;
