...
namespace Torrent.Serialization
{
    ...
    public static class XmlUtils
    {
        ...
        public static void WriteToFile(string filePath, object objectToWrite, bool append = false)
        {
        ...
        public static T ReadFromFile<T>(string filePath) where T : new()
        {
            ...
            try {
                ...
                DEBUG.ReportError(ex,
                                  $"Error Deserializing {typeof (T).GetFriendlyFullName()} From XML File at {filePath}");
            } finally {
                reader?.Close();
            }
            return new T();
