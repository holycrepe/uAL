namespace Torrent.Extensions
{
    ...
    {    	    	
    	...
    	[Conditional("TRACE")]
		public static void TRACE<TArgument1, TArgument2>(this Logger logger, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2)
    	...
    	[Conditional("DEBUG"), Conditional("TRACE")]
    	[StringFormatMethod("message")]
		public static void WARN<TArgument1, TArgument2, TArgument3>(this Logger logger, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3)
