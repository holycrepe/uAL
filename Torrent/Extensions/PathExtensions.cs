...
namespace Torrent.Extensions
{
	...
	{		
		...
		public static string StripFilename(this string filename, bool extended = true, Func<bool, IEnumerable<string>> getWordsToStrip = null)
		{
		...
		public static string TrimPath(this string fileName) {
			return fileName.TrimEnd(new char[] { '\\', '/' });
		}
