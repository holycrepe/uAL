...
namespace Torrent.Infrastructure
{
    ...
    {
        public LogEventInfoCloneable(LogLevel level, string loggerName, [Localizable(false)] string message, string group=null, string subject=null, Dictionary<string, object> eventInfo = null) : base(level, loggerName, message)
        {
            if (group != null)
            {
        ...
        public LogEventInfoCloneable Clone(Exception ex, string newMessage = null, Dictionary<string, object> newEventDict = null, string[] keysToDelete = null, 
                                           string group=null, string subject = null, string titleSuffix = null, string titleValue = null, LogLevel level = null) {
        	return Clone(newMessage, newEventDict, keysToDelete, group, subject, titleSuffix, titleValue, level, ex);
        }
        
        public LogEventInfoCloneable Clone(string newMessage = null, Dictionary<string, object> newEventDict = null, string[] keysToDelete = null, 
                                           string group=null, string subject = null, string titleSuffix = null, string titleValue = null, 
