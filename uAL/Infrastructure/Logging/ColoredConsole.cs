...
namespace uAL.Infrastructure
{
    public static class ColoredConsole
    {
        ...
        public static void WriteLine(string text, ConsoleColor Foreground, ConsoleColor Background, string suffix = "", string prefix = "")
        {
        ...
        public static void Write(string text, ConsoleColor Foreground, ConsoleColor Background, string suffix = "", string prefix = "")
        {
            CacheColors();
            if (prefix != "")
            {
